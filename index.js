...
const UUID = (process.env.UUID || "d70b6e0b-a417-4c84-ad29-239b0946b5ae").trim();        // 替换"双引号中的UUID"
const DOMAIN = (process.env.DOMAIN || "k9.huang12.de5.net").trim();                    // 替换"双引号中的完整域名"
